"""Stack-aware `doctor` for awreport.
...
interesting failures live BETWEEN them. "awreport is installed" is not the useful
fact -- "awreport is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awreport needs at runtime, and a
